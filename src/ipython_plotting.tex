...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Macros
\setbeamercolor{emphbar}{bg=orange!20, fg=black}
\newcommand{\emphbar}[1]
...
\titlegraphic{\includegraphics[width=2cm]{jsm_logo}\hspace*{4.75cm}~%
   \includegraphics[width=2cm]{INMANTEC-1}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
